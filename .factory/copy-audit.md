...
Audited 2026-08-30 against the rendered home page, isolated sample, feedback states, and README. Hyphenated compounds count as one word; symbols and numeric-only labels are omitted.
...
## Conditional, error, and dialog copy
...
The product UI, legal pages, catalog description, and README contain none of the banned marketing words. No reader-facing line exceeds 22 words.
